            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white p-8 rounded-[2rem] border border-navy-50 shadow-sm sticky top-8">
                        <h3 className="text-[10px] font-black text-navy-700 uppercase tracking-[0.3em] mb-8 px-2">Design Blocks</h3>
                        <div className="flex flex-col gap-4">
                            {[
                                ...
                                >
                                    <div className="w-8 h-8 rounded-lg bg-white flex items-center justify-center text-navy-700 group-hover:text-gold-600 shadow-sm transition-colors">
                                        {block.icon}
                                    </div>
                ...
                <div className="lg:col-span-3">
                            ...
                            <div className="space-y-8 min-h-[400px]">
                                {elements.map((element, index) => (
                                    <div key={element.id} className="group relative">
                                        ...
                                        {element.type === 'text' && (
                                            <p className="text-navy-700 font-bold uppercase text-[11px] tracking-widest leading-relaxed opacity-80">
                                                {element.content}
                                            </p>
                                        )}
                                        {element.type === 'button' && (
                    ...
                    <div className="mt-8 flex justify-between items-center px-12 opacity-50">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[9px] font-black text-navy-700 uppercase tracking-widest">Protocol Active: Auto-Save Enabled</span>
                        </div>
                        <p className="text-[9px] font-black text-navy-700 uppercase tracking-widest">Elements: {elements.length}</p>
                    </div>
                </div>
            </div>
        </div>
