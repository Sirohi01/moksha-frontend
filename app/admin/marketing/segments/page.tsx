    ...
    <div className="space-y-12 pb-24 animate-in fade-in duration-1000">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {[
          ...
          { label: 'Subscribers', count: '3,892', icon: <PieChart className="text-navy-700" /> },
          ...
          <div key={stat.label} className="bg-white p-8 rounded-[2rem] border border-navy-50 shadow-sm hover:shadow-xl transition-all group">
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-[9px] font-black text-navy-700 uppercase tracking-widest">{stat.label}</p>
            </div>
