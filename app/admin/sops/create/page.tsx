...
export default function CreateSOP() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      const res = await sopAPI.create(formData);
      if (res.success) {
  ...
  return (
    <div className="space-y-12 max-w-[1400px] mx-auto pb-32 animate-in fade-in duration-700">
      <div className="flex items-center justify-between">
        ...
        >
          {loading ? <div className="w-5 h-5 border-2 border-gold-500 border-t-transparent animate-spin rounded-full" /> : <Save className="w-5 h-5" />}
          Establish Protocol
        </button>
      </div>
            ...
            <div className="space-y-10 relative z-10">
              <div className="space-y-4">
                ...
                <input
                  ...
                  placeholder="E.G., MCD CLEARANCE WORKFLOW..."
              ...
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  placeholder="BRIEF OVERVIEW OF THIS PROTOCOL FOR CARDS..."
