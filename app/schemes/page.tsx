...
import { X, HelpCircle, ChevronRight, Phone, Mail, Building2, MapPin, ShieldCheck, RefreshCw } from "lucide-react";
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <label className="block text-sm font-medium text-stone-700 mb-1">
                        {activeConfig.form.labels.emailAddress} <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="email"
                        required
                        ...
                        className="w-full px-4 py-2 bg-stone-50 border border-stone-200 rounded-lg text-sm focus:ring-2 focus:ring-saffron-500 focus:border-transparent transition-all outline-none"
                      />
