                    ...
                    <div className="space-y-16">
                        {stories.map((story, i) => (
                            <div key={i} className="flex flex-col lg:flex-row items-center gap-12 group">
                                <div className="lg:w-1/2 w-full aspect-[3/2] md:aspect-video rounded-[3rem] overflow-hidden shadow-2xl relative">
                                    <Image src={getSafeSrc(story.image)} alt={getAlt(story.image, seo, story.imageAlt || "Moksha Seva Story")} fill className="object-cover group-hover:scale-105 transition-transform duration-1000" />
