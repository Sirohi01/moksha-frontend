      ...
      <div className={cn(
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="relative group">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-navy-700 group-focus-within:text-gold-600 transition-colors" />
            <input
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar px-4 pb-8 space-y-3">
          {loading ? (
            <div className="p-20 flex flex-col items-center gap-4">
              ...
              <p className="text-[9px] font-black text-navy-700 uppercase tracking-widest animate-pulse">Synchronizing Node Data...</p>
            </div>
            ...
            <div className="p-10 text-center space-y-4">
              ...
              <p className="text-[10px] font-black text-navy-700 uppercase tracking-[0.2em]">No Active Nodes Found</p>
            </div>
              ...
              <div className="relative flex-shrink-0">
                <div className={cn(
                  ...
                  selectedChat?._id === session._id
                    ...
                    : 'bg-navy-50 text-navy-700 group-hover:bg-navy-900 group-hover:text-gold-400'
                )}>
              ...
              <div className="flex-1 text-left min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <p className={cn(
                    ...
                    selectedChat?._id === session._id ? 'text-gold-200' : 'text-navy-700'
                  )}>
      ...
      <div className={cn(
        ...
        {selectedChat ? (
            ...
            <div className="px-6 py-6 sm:px-10 border-b border-navy-50 flex items-center justify-between bg-white/80 backdrop-blur-xl sticky top-0 z-10">
              <div className="flex items-center gap-4 sm:gap-6">
                <button
                  ...
                  className="lg:hidden p-3 text-navy-700 hover:text-navy-950 bg-navy-50 rounded-2xl mr-2"
                >
                  <X className="w-5 h-5" />
                </button>
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-4 mt-2">
                    <div className="flex items-center gap-2 group cursor-pointer">
                      <div className="w-5 h-5 rounded-lg bg-navy-50 flex items-center justify-center group-hover:bg-gold-100 transition-colors">
                        <Mail className="w-2.5 h-2.5 text-navy-700 group-hover:text-gold-600" />
                      </div>
                      <span className="text-[10px] font-bold text-navy-700 uppercase tracking-wider">{selectedChat.email}</span>
                    </div>
                    <div className="flex items-center gap-2 group cursor-pointer">
                      <div className="w-5 h-5 rounded-lg bg-navy-50 flex items-center justify-center group-hover:bg-gold-100 transition-colors">
                        <Phone className="w-2.5 h-2.5 text-navy-700 group-hover:text-gold-600" />
                      </div>
                      <span className="text-[10px] font-bold text-navy-700 uppercase tracking-wider">{selectedChat.phone}</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isRecording
                      ...
                      : 'bg-white text-navy-700 hover:bg-navy-950 hover:text-gold-500 border-navy-50 hover:border-navy-950'
                  )}
                >
          ...
          <div className="flex flex-col items-center justify-center text-center p-10 sm:p-20 max-w-md animate-in fade-in zoom-in duration-1000">
            ...
            <p className="text-[10px] font-black text-navy-700 uppercase tracking-[0.4em] leading-relaxed">System in high-readiness state. Select an active communication node from the directory to initialize uplink.</p>
            ...
            <div className="mt-12 grid grid-cols-2 gap-4 w-full opacity-60">
              <div className="p-4 bg-navy-50 rounded-2xl border border-navy-100">
                ...
                <p className="text-[7px] font-black uppercase text-navy-700 tracking-widest">Real-time Sync</p>
              </div>
              <div className="p-4 bg-navy-50 rounded-2xl border border-navy-100">
                <Shield className="w-4 h-4 text-navy-300 mx-auto mb-2" />
                <p className="text-[7px] font-black uppercase text-navy-700 tracking-widest">Encrypted Port</p>
              </div>
            </div>
          </div>
        )}
